...
class ResNextBottleNeckC(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride):
        ...
        self.split_transforms = nn.Sequential(
            ...
            nn.Conv2d(C * D, C * D, kernel_size=3, stride=stride,
...
def resnext50(num_classes=200):
    """ return a resnext50(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 6, 3], num_classes)


def resnext101(num_classes=200):
    """ return a resnext101(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 23, 3], num_classes)


def resnext152(num_classes=200):
    """ return a resnext101(c32x4d) network
    """
    return ResNext(ResNextBottleNeckC, [3, 4, 36, 3], num_classes)
